...
class EarlyFusion3DCNNTrainer(LightningModule):
    def __init__(self, hparams):
        ...
        self.batch_size_threshold = getattr(hparams.data, 'batch_size_threshold', 30)
    ...
    def forward(self, stance_video, swing_video):
        """Forward pass for both stance and swing videos."""
    ...
    def _shared_step(self, batch: torch.Tensor, stage: str):
        ...
        if stance_video.size()[0] + swing_video.size()[0] >= self.batch_size_threshold:
